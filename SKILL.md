...
- 优先使用无字道具替代可读文本：掌家印、钥匙串、玉佩、药盏、凤冠、断簪、血迹、火焰、空白卷轴轮廓、盖印红痕。
...
◎ 漫剧提示：{表情层次/服饰细节/道具特写/转场方式，只写可画内容}
...
- 每集至少 2 个可画成强画面的视觉钩子，如血迹、凤冠、玉佩碎裂、凤印、药盏、雨夜宫门、回眸冷笑；避免用可读文字做钩子
...
| 镜头 | 是否符合镜头语言，非台词段是否具备景别、可见画面和关键动作；是否存在抽象心理、修饰性叙述、不可画内容或画面可读文字风险 |
